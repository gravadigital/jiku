 ...
 * - Cambios operativos (área, persona, prioridad, fecha estimada, etapa) son internos
 * - Comentarios tienen visibilidad configurable (default: internal)
 */

import { activityVisibilityLevel } from '@jiku/models';

export type ActivityType = 'state' | 'area' | 'comment' | 'title' | 'person' | 'priority' | 'estimatedFinishDate' | 'description' | 'stageId';
