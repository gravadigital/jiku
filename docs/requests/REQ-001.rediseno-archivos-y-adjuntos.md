...
ux_review: done
created: 2026-08-19
targets: [S-001, S-002, S-003, S-004, S-005, S-006, S-007, S-008]
---
...
> **Formalizado el 2026-08-19.** Las stories existen en `docs/stories/`. El split se creó tal cual
> se propuso; lo único que cambia es la numeración, porque los ids de story son secuenciales y no
> admiten un "4b":
>
> | # propuesto | Story | Archivo |
> |---|---|---|
> | 1 | **S-001** | `S-001.separar-file-de-attachment.md` |
> | 2 | **S-002** | `S-002.modulo-files-en-core.md` |
> | 3 | **S-003** | `S-003.titularidad-y-fileids-en-comandos-de-dominio.md` |
> | 4 | **S-004** | `S-004.api-deja-de-escribir-y-recibir-el-byte.md` |
> | 4b | **S-005** | `S-005.lecturas-de-la-api-autorizar-y-redirigir.md` |
> | 5 | **S-006** | `S-006.subida-directa-a-s3-desde-web.md` |
> | 6 | **S-007** | `S-007.subida-directa-a-s3-desde-opus-web.md` |
> | 7 | **S-008** | `S-008.precondiciones-de-despliegue-del-bucket.md` |
>
> **El orden de implementación NO es el orden de los ids.** S-005 (la 4b) va **antes** que S-004 y
> puede correr en paralelo con S-003; ver el orden sugerido debajo de la tabla.
