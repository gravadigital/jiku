...
/**
 * La conexión de core: es el único servicio que escribe, así que usa el usuario dueño
 * de la base.
 *
 * Los modelos vienen de `@jiku/models` y se registran explícitamente. El paquete no
 * abre la conexión a propósito: la api usa la misma definición con otras credenciales.
 */
