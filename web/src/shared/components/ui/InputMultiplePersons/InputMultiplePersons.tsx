...
import styles from './InputMultiplePersons.module.scss';
...
export function InputMultiplePersons(props: InputProps) {
  const {
    label,
    code,
    value,
  ...
  const customStyles = {
    ...
    multiValue: (provided: any, state: any) => {
      ...
      return {
        ...provided,
        alignItems: 'center',
        backgroundColor: isFirst ? '#D9D9D9' : '#f5f2f0',
        borderRadius: 'var(--radius-items)',
        color: '#666',
        display: 'flex',
    ...
    multiValueLabel: (provided: any, state: any) => {
      ...
      return {
        ...provided,
        color: isFirst ? '#000' : 'var(--color-general-title)',
      };
    },
