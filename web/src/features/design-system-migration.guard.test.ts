...
/**
 * Guardia de regresión de S-056 (TS-19 a TS-24, TS-26, TS-27).
 *
 * El alcance del guardia son las tres carpetas que S-056 migró: `clients`, `projects` y
 * `objectives`, tanto en `app/(loggedin)/` como en `features/`. **No** cubre `requirements`,
 * `time-allocation` ni `worked-times`, que migran en S-057/S-058 y todavía tienen su propia
 * deuda — extender la lista `SCOPE_DIRS` es su trabajo, no de este archivo.
 *
...
describe('S-056: guardia de regresión de la migración al Design System', () => {
  ...
  it('TS-22: projects/new y projects/edit/[id] no contienen selectStyles ni importan react-select', () => {
    const files = [
